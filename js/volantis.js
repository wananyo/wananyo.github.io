  ...
  return function (e) {
          ...
          function n(e) {
              ...
              function n() {
                  if (0 !== e.scrollHeight) {
                      ...
                      e.style.height = "", e.style.height = e.scrollHeight + i + "px", s = e.clientWidth,
              ...
              function r() {
                  ...
                  if (o < r ? "hidden" === i.overflowY && (t("scroll"), n(), o = "content-box" ===
                          i.boxSizing ? Math.round(parseFloat(window.getComputedStyle(e, null).height)) :
                          e.offsetHeight) : "hidden" !== i.overflowY && (t("hidden"), n(), o =
              ...
              if (e && e.nodeName && "TEXTAREA" === e.nodeName && !o.has(e)) {
                  var i = null,
                      ...
                      d = function (t) {
                          window.removeEventListener("resize", c, !1), e.removeEventListener(
                              "input", r, !1), e.removeEventListener("keyup", r, !1), e.removeEventListener(
                              "autosize:destroy", d, !1), e.removeEventListener(
                              "autosize:update", r, !1), Object.keys(t).forEach(function (n) {
                              e.style[n] = t[n]
                          }), o.delete(e)
                      }.bind(e, {
                  ...
                  e.addEventListener("autosize:destroy", d, !1), "onpropertychange" in e &&
                      "oninput" in e && e.addEventListener("keyup", r, !1), window.addEventListener(
                          "resize", c, !1), e.addEventListener("input", r, !1), e.addEventListener(
                          "autosize:update", r, !1), e.style.overflowX = "hidden", e.style.wordWrap =
                      "break-word", o.set(e, {
                          destroy: d,
                          update: r
                      }),
                      function () {
                          ...
                          "vertical" === t.resize ? e.style.resize = "none" : "both" === t.resize &&
                              (e.style.resize = "horizontal"), i = "content-box" === t.boxSizing ?
          ...
          try {
              ...
              AV.applicationId && delete AV._config.applicationId || (AV.applicationId = void 0),
                  AV.applicationKey && delete AV._config.applicationKey || (AV.applicationKey =
                      void 0);
              var q = "-MdYXbMMI" === C.slice(-9) ? "https://us.avoscloud.com" :
                  "https://avoscloud.com";
              AV.init({
                  appId: C,
                  appKey: L,
              ...
              var z = u.findAll(document, ".valine-comment-count");
              u.each(z, function (t, n) {
                  if (n) {
              ...
              var T = e.config.el || null,
                  j = u.findAll(document, T);
              if (!(T = T instanceof HTMLElement ? T : j[j.length - 1] || null)) return;
              e.el = T, e.el.classList.add("v"), m.hide && e.el.classList.add("hide-avatar"), e.config
                  .meta = (e.config.guest_info || e.config.meta || b).filter(function (e) {
                      return b.indexOf(e) > -1
                  });
              var R = (0 == e.config.meta.length ? b : e.config.meta).map(function (t) {
              ...
              e.placeholder = e.config.placeholder || "Just Go Go", e.el.innerHTML =
                  '<div class="vwrap"><div class="vheader item' + R.length + '">' + R.join("") +
                  ...
                  o + "</div></div>";
              var B = u.find(e.el, ".vempty");
              e.nodata = {
                  show: function (t) {
                      return B.innerHTML = t || e.locale.tips.sofa, u.attr(B, "style",
                          "display:block;"), e
                  },
                  hide: function () {
                      return u.attr(B, "style", "display:none;"), e
                  }
              };
              ...
              e.loading = {
                  show: function (t) {
                      ...
                      return t ? P.insertBefore(I, n[0]) : P.appendChild(I), e.nodata.hide(),
                          e
                  },
                  hide: function () {
                      var t = u.find(P, ".vloading");
                      return t && u.remove(t), 0 === u.findAll(P, ".vcard").length && e.nodata
                          .show(), e
                  }
              };
              var U = u.find(e.el, ".vmark");
              e.alert = {
                  show: function (t) {
                      U.innerHTML = '<div class="valert txt-center"><div class="vtext">' +
                      ...
                      if (n.innerHTML = "" + r + (t && t.type && i), u.on("click", u.find(
                              U, ".vcancel"), function (t) {
                              e.alert.hide()
                          }), u.attr(U, "style", "display:block;"), t && t.type) {
      ...
      r.prototype.Q = function (e) {
          ...
          var j = u.find(t.el, ".vsubmit"),
              R = function (e) {
                  if (!u.attr(j, "disabled")) return "" == v.nick || "匿名" == v.nick ||
                      "Anonymous" == v.nick ? (alert("请输入昵称！"), void A.nick.focus()) : "" ==
                      v.mail ? (alert("请输入邮箱！"), void A.mail.focus()) : "" == v.comment ? (
                          alert("请输入内容！"), void A.comment.focus()) : (v.nick = v.nick || "匿名",
                          v.nick = v.nick || "Anonymous", void(t.notify || t.verify ? P(I) :
                              I()));
                  t.alert.show({
                      type: 0,
              ...
              I = function () {
                  ...
                  if (v.url = decodeURI(y), v.insertedAt = new Date, z.rid) {
                      var n = z.pid || z.rid;
                      e.set("rid", z.rid), e.set("pid", n), v.comment = v.comment.replace("<p>",
                          '<p><a class="at" href="#' + n + '">' + z.at + "</a> , ")
                  }
                  for (var r in v)
                      ...
                      try {
                          if (z.rid) {
                              var i = u.find(t.el, '.vquote[rid="' + z.rid + '"]') || M(z
                                  .rid);
                              C(e, i, !0)
                          } else n ? (r = Number(n.innerText) + 1, n.innerText = r) : u.find(
                                  t.el, ".vcount").innerHTML =
                              '<span class="num">1</span> ' + t.locale.tips.comments, C(e,
                                  u.find(t.el, ".vlist"));
                          v.mail && U({
                                  username: v.nick,
                                  mail: v.mail
                              }), z.at && z.rmail && t.notify && N({
                                  username: z.at.replace("@", ""),
                                  mail: z.rmail
                              }), u.removeAttr(j, "disabled"), t.loading.hide(), v.comment =
                              "", A.comment.value = "", w(A.comment), u.attr(A.comment,
                                  "placeholder", t.placeholder), z = {}, t.preview.empty()
                              .hide()
                      } catch (e) {
                          t.ErrorHandler(e)
                      }
          ...
          u.on("click", j, R), u.on("keydown", document, function (e) {
              ...
              (e.ctrlKey || e.metaKey) && 13 === t && R(), 9 === t && "veditor" == (
      ...
      var l = /[&<>"'`\\]/g,
          ...
          p = {
              ...
              dynamicLoadSource: function (e, t, n) {
                  ...
                  if (p.find(i, e + "[" + r + '="' + t + '"]')) "function" == typeof n && n();
                  else {
                      var o = p.create(e, r, t);
          ...
          return function (n, r) {
              ...
              return n.replace(s, function (e, t, n) {
                  if (n) return function (e) {
                      return '<span style="color: slategray">' + e +
                          "</span>"
                  }(n);
                  if ("<" === t) return "&lt;";
                  var r;
              ...
              g.autolink = c(g.autolink).replace("scheme", g._scheme).replace("email", g._email).getRegex(),
                  ...
                  g.normal = p({}, g), g.pedantic = p({}, g.normal, {
                      ...
                      for (var t, n, i, o, a, l = ""; e;)
                          ...
                          "@" === a[2] ? i = "mailto:" + (n = s(this.mangle(a[1]))) : i = n = s(a[
                              1]), l += this.renderer.link(i, null, n);
      ...
      function n(e) {
          return "<img class='emoji tieba' src='https://cdn.jsdelivr.net/gh/xaoxuu/volantis@1.0/img/tieba/" +
              e + ".png'>"
      }

      function r(e) {
          return "<img class='emoji qq' src='https://cdn.jsdelivr.net/gh/xaoxuu/volantis@1.0/img/qq/" +
              e + ".gif'>"
      }
      var i;
      e.exports = {
          aru151: (i = 151,
              "<img class='emoji aru' src='https://cdn.jsdelivr.net/gh/xaoxuu/volantis@1.0/img/aru/" +
              i + ".png'>"),
          "贴吧what": n("what"),
          "贴吧乖": n("乖"),
          "贴吧喷": n("喷"),
