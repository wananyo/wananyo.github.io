    ...
    function(e, t, n) {
        ...
        function c(e, t, n, r) {
            if (n = g(n), "href" === t || "src" === t) {
                ...
                if (E.lastIndex = 0, E.test(n) && ($.lastIndex = 0, $.test(n))) return ""; ! 1 !== r && (r = r || S, n = r.process(n))
            }
            return n = m(n)
        }
        function u(e) {
    ...
    function(e, t, n) { (function(t) { !
            function(t) {
                ...
                n.prototype.token = function(e, t) {
                    e = e.replace(/^ +$/gm, "");
                    for (var n, r, i, o, a, s, l, c, u, p, d, h, f, v, b, x; e;) if ((i = this.rules.newline.exec(e)) && (e = e.substring(i[0].length), i[0].length > 1 && this.tokens.push({
                        type: "space"
                    ...
                    this.tokens.push({
                        ...
                        d !== f - 1 && (a = y.bullet.exec(i[d + 1])[0], (o.length > 1 ? 1 === a.length: a.length > 1 || this.options.smartLists && a !== o) && (e = i.slice(d + 1).join("\n") + e, d = f - 1)),
                        r = n || /\n\n(?!\s*$)/.test(s),
                        d !== f - 1 && (n = "\n" === s.charAt(s.length - 1), r || (r = n)),
                        r && (l.loose = !0),
                        b = /^\[[ xX]\] /.test(s),
                        x = void 0,
                        b && (x = " " !== s[1], s = s.replace(/^\[[ xX]\] +/, "")),
                        u = {
        ...
        m = function() {
                ...
                value: function(e) {
                    ...
                    t.alert = {
                        show: function(e) {
                            ...
                            i = '<button class="vsure vbtn">' + (e && e.otxt || t.i18n.
                            continue) + "</button>";
            ...
            },
            {
                ...
                value: function(e) {
                    ...
                    v.on("click", t.el.querySelector(".vcancel-comment-reply"),
                    function(e) {
                        t.reset()
                    });
                    var i = function(e) {
                        e.offsetHeight > 180 && (e.classList.add("expand"), v.on("click", e,
                        function(t) {
                    ...
                    w = {};
                    for (var k in x) x.hasOwnProperty(k) &&
                    function() {
                        var e = x[k],
                    ...
                    t.reset = function() {
                        ...
                        u.nick = "",
                        A(),
                        C.getAttribute("triggered") && (C.setAttribute("style", "display:none;"), C.removeAttribute("triggered")),
                    ...
                    function(e) {
                        L.getAttribute("triggered") && (L.setAttribute("style", "display:none;"), L.removeAttribute("triggered")),
                        C.getAttribute("triggered") ? (C.setAttribute("style", "display:none;"), C.removeAttribute("triggered")) : (C.removeAttribute("style"), C.setAttribute("triggered", 1))
                    });
                    var T = t.el.querySelector(".vpreview-btn"),
                    L = t.el.querySelector(".vpreview-text");
                    v.on("click", T,
                    function(t) {
                        if (C.getAttribute("triggered") && (C.setAttribute("style", "display:none;"), C.removeAttribute("triggered")), L.getAttribute("triggered")) L.setAttribute("style", "display:none;"),
